...
class SlideableAnimatedList extends StatefulWidget {
  ...
  @override
  _SlideableAnimatedListState createState() =>
      new _SlideableAnimatedListState();
}

class _SlideableAnimatedListState extends State<SlideableAnimatedList>
  ...
  initState() {
    ...
    animationOffset = new Tween(
            begin: const Offset(0.0, 0.0), end: const Offset(-0.15, 0.0))
        .animate(new CurveTween(curve: Curves.decelerate).animate(controller));
    animationDouble = new Tween<double>(begin: 0.5, end: 1.0)
        .animate(new CurveTween(curve: Curves.decelerate).animate(controller));
  }
              ...
              new Positioned.fill(
                ...
                return new AnimatedBuilder(
                    ...
                    builder: (context, child) {
                      return new Stack(alignment: Alignment(0, 0), children: <
                          Widget>[
                        new Positioned(
                            right: .0,
                            top: .0,
