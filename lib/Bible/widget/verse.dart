...
import 'package:gec_app/Bible/inherited.dart';
import 'package:gec_app/Bible/model.dart';
...
class WidgetVerse extends StatelessWidget {
  ...
  WidgetVerse(
      {Key key, this.verse, this.keyword, this.selection, this.alsoInVerse})
      : super(key: key);
      ...
      children: <Widget>[
        if (verse.title.isNotEmpty)
          Container(
            ...
            child: Text(verse.title.toUpperCase(),
        ...
        Container(
            ...
            decoration: BoxDecoration(
                ...
                borderRadius: new BorderRadius.all(Radius.elliptical(3, 20)
            ...
            child: SelectableText.rich(
                ...
                onTap:
                    (selection is Function) ? () => selection(verse.id) : null
