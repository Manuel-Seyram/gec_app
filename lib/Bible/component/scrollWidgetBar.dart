...
class ScrollBarDelegate extends SliverPersistentHeaderDelegate {
  ScrollBarDelegate(this.builder,
  ...
  Widget build(
    ...
    return new SizedBox.expand(
        child:
            builder(context, shrinkOffset, overlapsContent, shrink, stretch));
  }
}

class ScrollPageBarDelegate extends ScrollBarDelegate {
  ScrollPageBarDelegate(this.builder,
      {this.minHeight, this.maxHeight, this.backgroundColor})
      : super(null);
  final double minHeight;
  final double maxHeight;
  final Color backgroundColor;
  ...
  Widget build(
    ...
    return Container(
        ...
        child: new SizedBox.expand(
            child: builder(
                context, shrinkOffset, overlapsContent, shrink, stretch)));
  }
}
