...
abstract class ScrollNotify {
  final ValueNotifier<double> bottomPercentageNotify =
  ...
  double get _bottomPosition =>
      ((bottomBarHeight * _shrink) - bottomBarHeight).toDouble();
  ...
  ValueListenableBuilder<double> bottomPercentageListener(
      {Widget Function(BuildContext, double, Widget) builder}) {
  ...
  ValueListenableBuilder<double> bottomPositionListener(
      {Widget Function(BuildContext, double, Widget) builder, bool disable}) {
    return ValueListenableBuilder<double>(
      valueListenable: bottomPositionNotify,
      builder: builder,
    );
