...
mixin _Bar on _State {
  ...
  Widget bar(BuildContext context, double offset, bool overlaps, double stretch,
      double shrink) {
          ...
          child: Row(
              ...
              children: <Widget>[
                AnimatedContainer(
                    ...
                    key: keyBookButton,
                    constraints:
                        BoxConstraints(maxWidth: width, minWidth: 30.0),
                    child: Tooltip(
                      message: "Tap to select book",
                      child: CupertinoButton(
                          color: (stretch <= 0.5)
                              ? null
                              : Colors.grey[400].withOpacity(stretch),
                          // minSize: 33,
                          minSize: (33 * stretch).clamp(25.0, 33.0),
                          padding:
                              EdgeInsets.symmetric(horizontal: 15 * stretch),
                ...
                AnimatedContainer(
                    ...
                    constraints:
                        BoxConstraints(maxWidth: 100.0, minWidth: 30.0),
                    child: Tooltip(
      ...
      Align(
          ...
          child: Tooltip(
            ...
            child: CupertinoButton(
                ...
                // ),
                child: Icon(CustomIcon.text_size,
                    color: Colors.grey,
                    size: (25 * stretch).clamp(15, 25).toDouble()),
                // child: Text('Aa'),
