...
class View extends _State with _Bar, _Gesture {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ScrollPage(controller: controller, child: _page()),
        ...
        builder: (BuildContext context, AsyncSnapshot<bool> snapshot) {
          switch (snapshot.connectionState) {
            case ConnectionState.waiting:
              return WidgetMessage(message: 'Getting things ready....');
            case ConnectionState.active:
              return WidgetMessage(message: 'loading...');
            case ConnectionState.none:
              return WidgetMessage(message: 'Almost there...');
    ...
    return new SliverToBoxAdapter(
      ...
      child: chapterGesture(
        ...
        itemBuilder: (BuildContext context, int id) =>
            _inheritedVerse(context, id, tmpverse[id]),
      )),
    );
  }
