...
abstract class _State extends State<Main> with TickerProviderStateMixin {
  ...
  Future<bool> get getResult =>
      _dataResult = hasNotResult ? _newResult : _dataResult;
  Future<bool> get _newResult async =>
      core.versePrimaryChapter().then((value) async {
  ...
  void showBookList() {
    ...
    Navigator.of(context)
        .push(PageRouteBuilder<int>(
            ...
            transitionsBuilder: (BuildContext _, Animation<double> x,
                    Animation<double> y, Widget child) =>
                new FadeTransition(opacity: x, child: child),
    ...
    Navigator.of(context)
        .push(PageRouteBuilder<int>(
            ...
            pageBuilder: (BuildContext context, x, y) => PopChapterList(
                  mainContext:
                      keyChapterButton.currentContext.findRenderObject(),
                  bible: bible,
                )))
        .then((e) {
      setChapter(e);
    ...
    Navigator.of(context)
        .push(PageRouteBuilder<int>(
            ...
            pageBuilder: (BuildContext _, x, y) => PopOptionList(
                  mainContext:
                      keyOptionButton.currentContext.findRenderObject(),
