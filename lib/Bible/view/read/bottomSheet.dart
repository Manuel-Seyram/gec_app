...
abstract class _BottomSheetState extends State<_BottomSheet>
    ...
    return DraggableScrollableActuator(
      ...
      child: NotificationListener<DraggableScrollableNotification>(
        ...
        child: DraggableScrollableSheet(
            ...
            key: UniqueKey(),
            expand: false,
            initialChildSize: initialChildSize < minChildSize
                ? minChildSize
                : initialChildSize,
            ...
            builder: (BuildContext _, ScrollController controller) {
              ...
              return sheetDecoration(
                  child: sheetShape(child: _scroll(controller)));
            }),
      ),
    );
  }
      ...
      body: CustomScrollView(
          ...
          slivers: <Widget>[
            ...
            new SliverPersistentHeader(
                pinned: true,
                delegate: new ScrollBarDelegate(_bar,
    ...
    return Row(
      ...
      children: [
        ...
        button(
            ...
            child: Icon(CustomIcon.language, size: 22),
                  ...
                  new Positioned(
                    ...
                    child: Opacity(
                      ...
                      child: Container(
                        ...
                        child: Text(verseSelectionList.length.toString(),
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: 13.0,
                            )),
