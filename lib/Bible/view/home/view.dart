...
class View extends _State with _Bar, _Refresh, _Info {
  ...
  int _indexOfKey(Key key) {
    return collectionBibleList
        .indexWhere((CollectionBible d) => ValueKey<String>(d.identify) == key);
  }
          ...
          Widget dragHandle = this.isSorting
              ? ReorderableListener(
                  child: Container(
                      ...
                      decoration: new BoxDecoration(color: Color(0x08000000)),
                      child: Icon(CustomIcon.drag_handle,
              ...
              child: Opacity(
                  ...
                  child: IntrinsicHeight(
                      child: new ListTile(
                          ...
                          selected: isPrimary,
                          enabled: true,
                          title: Text(collectionBible.name,
                              maxLines: 1,
                              ...
                              style: Theme.of(context)
                                  ...
                                  .copyWith(
                                      ...
                                      height:
                                          collectionBible.language.name == 'my'
                                              ? 2.0
                                              : 1.2)
                          ...
                          subtitle: Row(
                              ...
                              children: <Widget>[
                                ...
                                Text(' '),
                                Text(collectionBible.shortname,
                                    style: Theme.of(context)
                                        .textTheme
                                        .subtitle2
                                        .copyWith(
                          ...
                          onTap: () => isAvailable
                              ? this.toBible(collectionBible)
                              : this.showInfo(collectionBible)))));
        });
  }
}
