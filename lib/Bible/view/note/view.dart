...
class View extends _State {
  ...
  Widget body() {
    ...
    return new SliverPadding(
        padding: EdgeInsets.only(
            top: 7.0, bottom: MediaQuery.of(context).padding.bottom + 5.0),
              ...
              onPressed: () {
                ...
                core.keyBookmarkList.currentState.removeItem(
                    ...
                    (_, animation) => new SlideableAnimatedList(
                        key: id, menu: menu, animation: animation));
                setState(() {
  ...
  Widget bookmarksItem(CollectionBookmark bookmark) {
    ...
    DefinitionTestament testament =
        core.getDefinitionTestamentById(bookmark.bookId > 39 ? 2 : 1);
    return Container(
