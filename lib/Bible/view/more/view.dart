...
class View extends _State {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: DraggableScrollableActuator(
        child: DraggableScrollableSheet(
          ...
          // maxChildSize: 1.0,
          builder: (BuildContext context, ScrollController scrollController) {
            return DraggableScrollableSheetTest(
  ...
  Widget bar(BuildContext context, double offset, bool overlaps, double shrink,
      double stretch) {
    return Container(child: Center(child: Text('More: $shrink')));
  }
...
class DraggableScrollableSheetTest extends StatelessWidget {
      ...
      body: CustomScrollView(
          ...
          slivers: <Widget>[
            new SliverPersistentHeader(
                pinned: true,
                floating: true,
                delegate: new ScrollPageBarDelegate(_bar)),
            // new SliverToBoxAdapter(
            //   child: Center(
            //     child: Text("? : ${core.identify}"),
            //   )
  ...
  Widget _bar(BuildContext context, double shrinkOffset, bool overlapsContent,
