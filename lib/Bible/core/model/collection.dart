...
class Collection {
  ...
  Collection(
      {this.version, this.bible, this.bookmark, this.keyword, this.setting});
  ...
  factory Collection.fromJSON(Map<String, dynamic> o) {
    ...
    return Collection(
        ...
        bible: (o['bible'] ?? o['book'])
            .map<CollectionBible>((json) => CollectionBible.fromJSON(json))
            .toList(),
        bookmark: o['bookmark']
            .map<CollectionBookmark>(
                (json) => CollectionBookmark.fromJSON(json))
            .toList(),
        keyword: o['keyword']
            .map<CollectionKeyword>((json) => CollectionKeyword.fromJSON(json))
            .toList(),
...
class CollectionBookmark {
  ...
  Map<String, dynamic> toJSON() {
    return {'bookId': this.bookId, 'chapterId': this.chapterId};
  }
}
...
class CollectionKeyword {
  ...
  factory CollectionKeyword.fromJSON(String word) {
    return CollectionKeyword(word: word);
  }
...
class CollectionBible {
  ...
  Map<String, dynamic> userSetting() {
    return {'available': this.available, 'order': this.order};
  }
}
...
class CollectionLanguage {
  ...
  factory CollectionLanguage.fromJSON(Map<String, dynamic> o) {
    return CollectionLanguage(
        text: o['text'], textdirection: o['textdirection'], name: o['name']);
  }
