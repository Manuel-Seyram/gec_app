...
class VerseInheritedWidget extends InheritedWidget {
  ...
  static VerseInheritedWidget of(BuildContext context) =>
      context.dependOnInheritedWidgetOfExactType<VerseInheritedWidget>();

  @override
  bool updateShouldNotify(VerseInheritedWidget old) =>
      size != old.size ||
