...
mixin _Utility {
  ...
  Future<void> analyticsBook(
      String bibleName, String bookName, String chapterId) async {
    await _analytics
        .logEvent(name: 'select_book', parameters: <String, dynamic>{
  ...
  Future<void> analyticsScreen(String name, String classes) async {
    ...
    await _analytics.setCurrentScreen(
        screenName: name, screenClassOverride: classes);
  }
