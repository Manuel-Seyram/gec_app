...
mixin _Configuration {
  ...
  String version = '';
  String buildNumber = '';
  final String appDescription = 'Holy Bible';
  ...
  final String _liveBookJSON =
      'nosj.koob/retsam/elbib/ohtgnaisial/moc.tnetnocresubuhtig.war//:sptth';
  ...
  set searchQuery(String searchQuery) =>
      collection.setting.searchQuery = searchQuery;
