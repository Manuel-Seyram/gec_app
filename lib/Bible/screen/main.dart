...
import 'package:gec_app/Bible/view/home/main.dart' as Home;
import 'package:gec_app/Bible/view/read/main.dart' as Read;
import 'package:gec_app/Bible/view/note/main.dart' as Note;
import 'package:gec_app/Bible/view/search/main.dart' as Search;
// import 'package:bible/view/more/main.dart' as More;
import 'package:gec_app/Bible/screen/SplashScreen.dart';
...
class _MainState extends State<MainView> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    if (pageView.length == 0) {
      pageButton = [
        ModelPage(
            icon: CustomIcon.flag,
            name: "Home",
            description: "List of Holy Bible",
            key: home),
        ModelPage(
            icon: CustomIcon.book_open,
            name: "Read",
            description: "Read bible by chapter",
            key: read),
        ModelPage(
            icon: CustomIcon.list_nested,
            name: "Bookmark",
      ...
      pageView = [
        WidgetKeepAlive(
            key: homeKey, child: new Home.Main(key: home, barMaxHeight: 120)),
        ...
        builder: (BuildContext context, AsyncSnapshot<void> snapshot) {
          switch (snapshot.connectionState) {
            ...
            case ConnectionState.none:
              return SplashScreen(message: 'Almost there...');
              break;
