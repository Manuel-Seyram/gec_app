...
class ValueNotifierInheritedModel
  ...
  static int of(BuildContext context) => context
      .dependOnInheritedWidgetOfExactType<ValueNotifierInheritedModel>()
      .notifier
      .value;
}
              ...
              ValueNotifierInheritedModel(
                  ...
                  child: Column(
                      ...
                      children: <Widget>[
                        ...
                        FlatButton(
                            child: Text("Change ValueNotifierInheritedModel",
                                style: TextStyle(color: Colors.red)),
                            onPressed: () {
                              spinNotify.value++;
                            })
